            ...
            <?php echo $data['alert']?>
				...
				<h5>Sign up once and watch any of our free demos.</h5>
					<form class="" method="post" action="#">
						...
						<div class="form-group ">
							<input onclick="alert('Your account has been deleted')" href="" target="_blank" type="submit" id="delete" name="delete" value="DELETE ACCOUNT" style="background:red" class="btn btn-primary btn-lg btn-block login-button">
					</div>
					</form>
